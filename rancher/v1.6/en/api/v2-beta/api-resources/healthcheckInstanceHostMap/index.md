...
apiVersion: v2-beta
#redirect_from:
#  - /rancher/v1.6/zh/api/v2-beta/api-resources/healthcheckInstanceHostMap/
---
...
kind | string  | 
removeTime | date  | The date and time of when the healthcheckInstanceHostMap was removed
