...
apiVersion: v2-beta
#redirect_from:
#  - /rancher/v1.6/zh/api/v2-beta/api-resources/externalHandlerExternalHandlerProcessMap/
---
...
<span class="header">
activate
<span class="headerright">POST:  <code>/v2-beta/projects/${PROJECT_ID}/externalHandlerExternalHandlerProcessMaps/${ID}?action=activate</code></span></span>
...
<span class="header">
deactivate
<span class="headerright">POST:  <code>/v2-beta/projects/${PROJECT_ID}/externalHandlerExternalHandlerProcessMaps/${ID}?action=deactivate</code></span></span>
<div class="action-contents">
