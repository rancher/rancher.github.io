...
Both values can be generated by following the procedure to create an Azure App Registration described [here](https://www.rancher.com/docs/rancher/latest/en/hosts/azure/#app-registration).
