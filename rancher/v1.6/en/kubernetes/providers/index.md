...
Currently, Rancher supports three cloud providers when [configuring Kubernetes]({{site.baseurl}}/rancher/{{page.version}}/{{page.lang}}/kubernetes/#configuring-kubernetes). You can select which cloud provider to use.
...
### Azure
* **Nodes:** Supports both [custom hosts]({{site.baseurl}}/rancher/{{page.version}}/{{page.lang}}/hosts/custom/) and using [Azure Hosts]({{site.baseurl}}/rancher/{{page.version}}/{{page.lang}}/hosts/azure/)
* **Load Balancers:** Launches an Azure Load Balancer within a specific Security Group.
...
###### Azure Security Group
Custom Azure Security Group needed to allow Azure Load Balancers to work. If you provision hosts using Rancher Machine Azure driver, you will need to edit them manually to assign them to this Security Group. You should already assign custom hosts to this Security Group during provisioning.
