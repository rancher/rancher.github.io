...
Rancher also supports importing existing container upon host registration. When you register a host through the [Adding Custom Hosts]({{site.baseurl}}/rancher/rancher-ui/infrastructure/hosts/custom/), any containers currently on the host will be detected and imported into Rancher.
