...
<span class="header">
activate
<span class="headerright">POST:  <code>/v2-beta/machineDrivers/${ID}?action=activate</code></span></span>
...
-X POST \
'http://${RANCHER_URL}:8080/v2-beta/machineDrivers/${ID}?action=activate'
{% endhighlight %}
<br>
...
<span class="header">
deactivate
<span class="headerright">POST:  <code>/v2-beta/machineDrivers/${ID}?action=deactivate</code></span></span>
<div class="action-contents">
...
curl -u "${RANCHER_ACCESS_KEY}:${RANCHER_SECRET_KEY}" \
-X POST \
'http://${RANCHER_URL}:8080/v2-beta/machineDrivers/${ID}?action=deactivate'
{% endhighlight %}
<br>
<span class="output"><strong>Output:</strong> An updated copy of the <a href="{{site.baseurl}}/rancher/{{page.version}}/{{page.lang}}/api/{{page.apiVersion}}/api-resources/machineDriver/">machineDriver</a> resource</span>
</div></div>
...
<span class="header">
reactivate
<span class="headerright">POST:  <code>/v2-beta/machineDrivers/${ID}?action=reactivate</code></span></span>
<div class="action-contents">
...
curl -u "${RANCHER_ACCESS_KEY}:${RANCHER_SECRET_KEY}" \
-X POST \
'http://${RANCHER_URL}:8080/v2-beta/machineDrivers/${ID}?action=reactivate'
{% endhighlight %}
<br>
<span class="output"><strong>Output:</strong> An updated copy of the <a href="{{site.baseurl}}/rancher/{{page.version}}/{{page.lang}}/api/{{page.apiVersion}}/api-resources/machineDriver/">machineDriver</a> resource</span>
</div></div>
