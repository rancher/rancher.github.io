...
Since you already have Rancher server running, you need to set up your AWS credentials and just run `rancher-compose` with your Rancher server URL and [API key]({{site.baseurl}}/rancher/{{page.version}}/{{page.lang}}/configuration/api-keys/).
