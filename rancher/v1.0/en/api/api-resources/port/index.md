...
privateIpAddressId | [ipAddress]({{site.baseurl}}/rancher/{{page.version}}/{{page.lang}}/api/api-resources/ipAddress/) | - | - | - | The unique identifier of the private IP address
privatePort | int | - | - | - | The private port
protocol | string | - | - | - | 
publicIpAddressId | [ipAddress]({{site.baseurl}}/rancher/{{page.version}}/{{page.lang}}/api/api-resources/ipAddress/) | - | - | - | The unique identifier of the public IP address
publicPort | int | - | Yes | - | 
...
<span class="output"><strong>Output:</strong> An updated copy of the <a href="/rancher/api/api-resources/port/">port</a> resource</span>
</div>
</div>
