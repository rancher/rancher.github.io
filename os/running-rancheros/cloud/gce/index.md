...
2. Follow Google's instructions on how to [upload an image to your custom image list](https://cloud.google.com/compute/docs/images/import-existing-image#import_image).

3. Once the image is added to your Google Compute Engine, we can start creating new instances!
