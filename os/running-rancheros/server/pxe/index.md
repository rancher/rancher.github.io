...
kernel ${base-url}/vmlinuz rancher.state.autoformat=[/dev/sda] rancher.state.dev=LABEL=RANCHER_STATE rancher.cloud_init.datasources='["url:http://example.com/cloud-config"]'
